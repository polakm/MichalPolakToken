...
contract('MichalPolakToken', function ([contract, creator, usualAccount]) {
  ...
  describe('Tranfering.test.js', function () {
    ...
    it('After transferring tokens by contract owner to usual account, the total supply remains unchanged', async function () {
    ...
    it('After transferring tokens by contract owner to usual account, the cap remains unchanged', async function () {
